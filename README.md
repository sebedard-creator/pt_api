...
| | `get_timeline_clips()` | Returns a chronological list of all events placed on the timeline, including start/end samples and source offsets (`src_offset_samples`). |
